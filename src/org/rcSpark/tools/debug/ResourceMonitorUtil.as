...
package org.rcSpark.tools.debug
{
	...
	/**
	 * <img src='http://chargedweb.com/labs/files/2010/02/resourcemonitor.png' /><br/>
	 ...
	 * </ul>
	 *
	 * <p><img src='http://chargedweb.com/labs/files/2010/02/smile.png' /></p>
	 *
	...
	public class ResourceMonitorUtil extends Sprite
	{
		...
		private function countMemoryMaxUsed():int
		{
			...
			for(var i:int = 0; i < _historyLength; i++)
			{
				if(_history[i].memory > m) m = _history[i].memory;
			}
