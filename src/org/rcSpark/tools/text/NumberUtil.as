...
package org.rcSpark.tools.text
{
	...
	/****
	 * NumberUtil.as class. Created Aug 17, 2012 12:39:53 AM
	 * <br>
	 * Description:
	 * @author ryan
	 * @langversion 3.0
	...
	{		
		 ...
		 * 
		 * @param date	日期
		 * @param format	日期格式（mm-dd,yyyy-mm-dd,yyyy-m-d,yyyy年m月d日,Y年M月D日）
		 * @return 转换完毕的字符串
		 * 
		 */		
		 ...
		 * 
		 * @param date	日期
		 * @param format	时间格式（hh:mm,h:m,hh:mm:ss，h:m:s，hh:mm:ss:ss.s，h:m:s:ss.s，h点m分s秒，H点M分S秒）
		 * @return 转换完毕的字符串
		 * 
		 */		
