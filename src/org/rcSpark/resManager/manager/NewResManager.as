/**
 * Class name:NewResManager.as
 * Description:
 * Author: Ryan
 * Created: 13-12-13 下午5:13
 */
...
public class NewResManager {
    ...
    {
        //LoadManager.instance().load(type, url, loadLevel, ct, onCompleteHandler, onProgressHandler, onErrorHandler);
